                                ...
                                <li class="one_quarter first">
                                    ...
                                    <div class="clear">
                                        ...
                                        <div>
                                            ...
                                            ?>
                                            <div>
                                                <form action="http://localhost/proposalregister/pages/Club_Updatev2.php" method="post">
                                                    <table style="color: grey">
                                                        <tr>
                                                            <td><label for="clubID"><b>Club ID</b></label></td>
                                                            <td><input type="text" id="clubID" name="clubID" required/></td>
                                                        </tr>
                                                        <tr>
                                                            <td><input type="submit" name="update" value="Search Club"/></td>
