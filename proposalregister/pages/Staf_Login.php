        ...
        <div class="wrapper row3">
          <div class="rounded">
            <main class="container clear">
                <div id="gallery">
                    <figure>
                        <header class="heading">Login as Staff</header>
                                ...
                                <div class="clear">
                                    ...
                                    <div>
                                        <fieldset>
                                            ...
                                            <form action="http://localhost/proposalregister/pages/Staf_Loginv2.php" method="post">
                                                <table style="color: grey">
                                                    ...
                                                    <tr>
                                                        <td><label for="staPass"><b>Password</b></label></td>
                                                        <td><input type="password" name="staPass" id="staPass" required/></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td colspan="2">
                                                            <input type="submit" name="staLog" value="Login"/>
