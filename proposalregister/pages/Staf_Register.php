        ...
        <div class="wrapper row3">
            <div class="rounded">
                <main class="container clear"> 
                    <div id="gallery">
                        <figure>
                            <header class="heading">Register as Staff</header>
                            <ul class="nospace clear">
                                <li class="one_quarter first">
                                    <nav class="pagination"></nav>
                                    <div class="clear">
                                        <!-- Borang nak register staff -->
                                        <div>
                                            <form method="post" action="http://localhost/proposalregister/pages/Staf_Registerv2.php">
                                                <table style="color:grey">
                                                    <tr>
                                                        <td><label for="staffID"><b>Staff ID</b></label></td>
                                                        <td><input type="text" name="staffID" id="staffID" required/></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label for="staffName"><b>Staff Name</b></label></td>
                                                        <td><input type="text" name="staffName" id="staffName" required/></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td><label for="staffDept"><b>Staff Department</b></label></td>
                                                        <td><input type="text" name="staffDept" id="staffDept" required/></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label for="staffPost"><b>Staff Position</b></label></td>
                                                        <td><input type="text" name="staffPost" id="staffPost" required/></td>
                                                    </tr>
                                                </table>
