...
if(isset($_POST["delete"])) {
    $sql = "DELETE FROM student WHERE Stu_ID='" . $_SESSION["stuID"] . "'";
                                ...
                                <li class="one_quarter first">
                                    ...
                                    <div class="clear">
                                        ...
                                        <div>
                                            ...
                                            ?>
                                            <div>
                                                <form method="post" action="http://localhost/proposalregister/pages/Stud_Deletev3.php">
                                                    <table style="color:grey">
                                                        <tr>
                                                            <td>ID</td>
                                                            <td><input type="hidden" name="stuID" value="<?php echo $id; ?>"/><?php echo $id; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Name</td>
                                                            <td><?php echo $name; ?></td>
