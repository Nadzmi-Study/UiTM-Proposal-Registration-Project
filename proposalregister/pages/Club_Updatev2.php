        ...
        <div class="wrapper row3">
            <div class="rounded">
                <main class="container clear"> 
                    <div id="gallery">
                        <figure>
                            <header class="heading">Update Club</header>
                            <ul class="nospace clear">
                                <li class="one_quarter first">
                                    <nav class="pagination"></nav>
                                    <div class="clear">
                                        <!-- Borang nak update club -->
                                        <div>
                                            <?php
                                                if(isset($_SESSION["AID"]) && $_SESSION["AID"]!=null) {
                                                    // get club id for that staff
                                                    $sql2 = "SELECT * FROM club WHERE C_ID='" . $_POST["clubID"] . "'";
                                            ...
                                            ?>
                                            <div>
                                                <form action="http://localhost/proposalregister/pages/Club_Updatev3.php" method="post">
                                                    <table style="color: grey">
                                                        <tr>
                                                            <td><label for="clubName"><b>Club ID</b></label></td>
                                                            <td><input type="hidden" id="clubName" name="clubID"  value="<?php echo $id; ?>"/><?php echo $id; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label for="clubName"><b>Club Name</b></label></td>
                                                            <td><input type="text" id="clubName" name="clubName"  value="<?php echo $name; ?>"/></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label for="clubDesc"><b>Club Description</b></label></td>
                                                            <td><textarea id="clubDesc" name="clubDesc"><?php echo $desc; ?></textarea></td>
                                                        </tr>
                                                        <tr>
                                                            <td><input type="submit" name="update" value="Update Club"/></td>
...
<?php
        ...
        $sql2 = "UPDATE club SET C_Name='$name', C_Desc='$desc' WHERE C_ID='" . $fetch["C_ID"] . "'";
