...
if(isset($_POST["delete"])) {
    ...
    $sql = "DELETE FROM proposal WHERE Stu_ID='" . $_SESSION["stuID"] . "'";
        ...
        <div class="wrapper row3">
            <div class="rounded">
                <main class="container clear"> 
                    <div id="gallery">
                        <figure>
                            <header class="heading">Delete Proposal</header>
                                ...
                                <li class="one_quarter first">
                                    ...
                                    <div class="clear">
                                        ...
                                        <div>
                                            ...
                                            if(isset($_SESSION["AID"]) && $_SESSION["AID"]!=null) {
                                                // get proposal details
                                                $sql = "SELECT * FROM proposal WHERE P_ID='" . $_POST["propID"] . "'";
                                                ...
                                                $stuID = $fetch["Stu_ID"];
                                            ?>
                                                <form method="post" action="http://localhost/proposalregister/pages/Prop_Deletev3.php">
