...
if(isset($_POST["delete"])) {
    $sql = "DELETE FROM staff WHERE Sta_ID='" . $_SESSION["staID"] . "'";
                                ...
                                <li class="one_quarter first">
                                    ...
                                    <div class="clear">
                                        ...
                                        <div>
                                            ...
                                            ?>
                                            <div>
                                                <form method="post" action="http://localhost/proposalregister/pages/Staf_Deletev3.php">
                                                    <table style="color:grey">
                                                        <tr>
                                                            <td><b>Staff ID</b></td>
                                                            <td><input type="hidden" name="staID" value="<?php echo $id; ?>"/><?php echo $id; ?></td>
                                                        </tr>
                                                        <tr>
